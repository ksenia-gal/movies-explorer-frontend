...
function Navigation({ isLoggedIn }) {
  ...
  return (
    ...
    <div className={`menu__container ${isMenuOpen ? 'menu__container_opened' : ''}`}>
      {isLoggedIn ? (
        <>
          <NavLink exact to="/" activeclassname='menu__nav-link_active' className='menu__nav-link'>
            Главная
          </NavLink>
          <NavLink to="/movies" activeclassname='menu__nav-link_active' className='menu__nav-link'>
            Фильмы
          </NavLink>
          <NavLink to="/saved-movies" activeclassname='menu__nav-link_active' className='menu__nav-link'>
            Сохраненные фильмы
          </NavLink>
        </>
      ) : (
